...
let pinkSize = 45; //change this to above 50 or below 50 for diff pattern
...
//IF STATEMENTS 
if(darkgreenSize >80){
fill(219,97,97);//dark pink circle
ellipse(0,0,60,60);
fill(219,97,97);
...
if(lightgreenSize >90){
  fill(117,184,85);//light green circle
ellipse(50,50,30,30);
ellipse(50,50,10,10);
}
else{
fill(21,114,65);//dark green circle
ellipse(50,50,30,10);
ellipse(50,50,10,30);
}

if(pinkSize <50){
fill(21,114,65);//big dark green circle
ellipse(160,160,170,170);
}
else{
fill(0,0,0);//black seed
